...
var Gesto = /*#__PURE__*/ (function (_super) {
    ...
    function Gesto(targets, options) {
            ...
            if (isDragStart) {
                ...
                if (target) {
                    ...
                    if (preventClickEventOnDragStart || preventClickEventOnDrag || preventClickEventByCondition) {
                        utils.addEvent(_this._window, "click", _this._onClick, true);
                    }
                }
        ...
        _this._allowClickEvent = function () {
            utils.removeEvent(_this._window, "click", _this._onClick, true);
        };
        ...
        _this._window = utils.isWindow(firstTarget) ? firstTarget : utils.getWindow(firstTarget);
        _this.options = __assign({ checkInput: false, container: firstTarget && !("document" in firstTarget) ? utils.getWindow(firstTarget) : firstTarget, preventRightClick: true, preventWheelClick: true, preventClickEventOnDragStart: false, preventClickEventOnDrag: false, preventClickEventByCondition: null, preventDefault: true, checkWindowBlur: false, keepDragging: false, pinchThreshold: 0, events: ["touch", "mouse"] }, options);
        ...
        if (checkWindowBlur) {
            utils.addEvent(utils.getWindow(), "blur", _this.onBlur);
        }
        if (_this._useTouch) {
            var passive_1 = {
                passive: false,
