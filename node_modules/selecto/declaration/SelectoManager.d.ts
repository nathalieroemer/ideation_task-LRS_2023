...
import { SelectoOptions, SelectoProperties, SelectoEvents, SelectedTargets, SelectedTargetsWithRect } from "./types";
/**
...
declare class Selecto extends EventEmitter<SelectoEvents> {
     ...
     */
    setSelectedTargets(selectedTargets: Array<HTMLElement | SVGElement>): SelectedTargets;
    /**
